...
<div class="container">
    ...
    <select class="form-control mb-2" name="continente" id="">
    ...
    <select class="form-control mb-2" name="regiao_continente" id="regiao_continente">
        ...
        <input class="form-control mb-2" type="text" name="evento" id="" placeholder="Insira um evento...">
